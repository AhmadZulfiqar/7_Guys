  ...
  return (
    <nav className="sticky top-0 z-50 flex items-center justify-between px-10 py-4 bg-green-700 shadow-xl border-b-4 border-yellow-400">
      ...
      <ul className="hidden md:flex items-center space-x-10 font-bold text-white uppercase tracking-wide text-sm">
        ...
        <li>
          <Link to="/pizza" className="hover:text-yellow-400 transition-colors">Pizzas</Link>
        </li>
        <li>
          <Link to="/burgers" className="hover:text-yellow-400 transition-colors">Burgers</Link>
        </li>
        <li>
          <Link to="/drinks" className="hover:text-yellow-400 transition-colors">Drinks</Link>
        </li>
        <li>
          <Link to="/deals" className="bg-yellow-400 text-green-800 px-3 py-1 rounded-md hover:bg-white transition-colors">Hot Deals</Link>
        </li>
      </ul>
